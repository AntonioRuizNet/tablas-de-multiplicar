...
export default function Amigos() {
  const [data,setData]=useState({search:[],pendingReceived:[],pendingSent:[],friends:[]}); const [query,setQuery]=useState(""); const [message,setMessage]=useState(""); const [hasSearched,setHasSearched]=useState(false);
  ...
  const search=(event)=>{event.preventDefault();setHasSearched(true);load(query);};
