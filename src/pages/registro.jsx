...
export default function Registro() {
  ...
  return <AppLayout title="Crear cuenta | Tablas de multiplicar" description="Crea una cuenta para guardar tu progreso en las tablas de multiplicar.">
    ...
    <div className={styles.page}><section className={styles.card}>
      ...
      <p className={styles.subtitle}>Solo necesitas un nick y una contraseña. El email es opcional y sirve para recuperar tu cuenta.</p>
      <form className={styles.form} onSubmit={submit}>
        ...
        <label className={styles.label}>Email <small>(opcional)</small><input className={styles.input} name="email" type="email" autoComplete="email" value={form.email} onChange={change} /></label>
